...
FROM "players"
WHERE "birth_country" IS NOT NULL AND "birth_country" IS NOT "USA"
...
WHERE "bats" == "R"
ORDER BY "first_name" ASC, "last_name" ASC;
-- write a SQL query to return the first name, last name, and debut date 
-- of players born in Pittsburgh, Pennsylvania (PA). 
-- Sort the results first by debut date—
-- from most recent to oldest—then alphabetically 
...
-- who bat (or batted) right-handed 
...
-- of baseball players who debuted 
-- on or after January 1st, 2000. 
-- Return the columns 
-- with the name “Average Height” and “Average Weight”, respectively.
SELECT 
...
-- who played their final game in the MLB in 2022. 
-- Sort the results alphabetically by first name, then by last name.
SELECT "first_name", "last_name"
FROM "players"
